...
- **Chart:** A Helm package bundling K8s resource definitions
- **Repository:** A place charts are published and pulled from
- **Release:** One running install of a chart in a cluster
- **Values:** The knobs that parameterize a chart at install time
...
For templating, hooks, and packaging, head to `kubernetes-helm-advanced.md`.
