...
Worked patterns for the documentation situations that come up again and again.
...
**Naming conventions:**
- Give nodes IDs that say something: `userService`, not `A`
- Spell labels out: `[User Service]`, not `[US]`
- Let edges carry meaning: `-->|authenticates|`, not a bare `-->`
...
**Security:**
Keep `securityLevel: 'strict'` so user-supplied diagrams can't slip XSS through.
