...
**Push to the extreme and the fundamentals show themselves.** A design that holds at one scale quietly falls apart at another.
...
**Shrink it as well as grow it:**
- One lone user — does all that machinery still earn its place?
- Ten items — is the optimization solving a problem you don't have?
- Instant response — what part of the design just became dead weight?

Going small is how over-engineering and premature optimization give themselves away.
...
- The extremes show you what normal scale keeps hidden
- Holding at one scale is no promise it holds at the next
- Run it BOTH ways — bigger and smaller
- Let what you learn check the architecture while it's still cheap to change
- Don't guess at the limits — go find them
