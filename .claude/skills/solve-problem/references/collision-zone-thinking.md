...
Breakthroughs come from mixing metaphors on purpose. Decide to treat X as if it were Y, then study what surfaces.
...
The richest seams to mine concepts from:
...
- The wildest pairings tend to throw off the best insights
- Push hard on where the metaphor stops holding
- Keep the collisions that failed too — they still teach
- A breakthrough is worth more than another increment
- Ask yourself: "how would a [domain expert] handle this?"
