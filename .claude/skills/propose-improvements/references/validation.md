...
**Runs:** one instance per item — the orchestrator fans out one subagent per surviving
item, batched at ≤10 concurrent globally. Each instance validates exactly ONE item and
writes ONE verdict file. Do not batch or peek at sibling items/verdicts.
