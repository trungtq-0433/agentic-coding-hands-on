# Searching a Whole Library's Docs

**Reach for this when:** the user wants the lay of an entire library or framework
...
The scripts step down the chain for you:
1. `fetch-docs.js` tries context7.com
2. On a 404, the script points you at a WebSearch for llms.txt
3. Still nothing: [Repository Analysis](./repo-analysis.md)
