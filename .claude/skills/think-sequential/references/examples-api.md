# Worked Example — Designing an API the Sequential Way
...
(Skips the edge cases, the scaling story, the security holes.)
...
1. **A revision caught a security hole**: tenant IDs were readable in the claims
2. **The count flexed with the work**: 5 thoughts grew to 7 as complexity surfaced
3. **Nothing was left half-covered**: authentication, authorization, multi-tenancy, and revocation all landed
