...
- If `graphify-out/graph.json` exists (Knowledge Graph is on by default), load `../../_shared/graphify-code-graph.md` and use `graphify affected/path/explain` to seed dependency and impact paths
