...
## Free Tier
- Free outright on public repos
- 1GB repo size, 100GB bandwidth/mo, 10 builds/hr

## Rollback
Revert the commit and push, or re-run an earlier workflow

## Best For
Static output only — docs, portfolios, project pages. Nothing runs server-side.
