...
- D1, R2, and KV each carry their own free tier
...
## Best For
Reach for it when you want edge functions, static sites fronted by a global CDN, or serverless running close to the user.
