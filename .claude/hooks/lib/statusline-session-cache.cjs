...
/**
 * Statusline session-cache utilities — normalize, sanitize, and persist
 * per-session activity snapshots (agents + todos) through the session state API.
 *
 * @module statusline-session-cache
 */
