#!/usr/bin/env node
/**
 * Project and environment detection — shared by session-init and OpenCode plugins.
 *
 * Detects project type, package manager, framework, Python, and Git state.
 * Extracted from session-init.cjs to keep detection logic reusable and testable.
 *
