  ...
  describe('isPrivacySensitive', () => {
    ...
    describe('credentials and secrets', () => {
      ...
      it('blocks secrets files', () => {
        ...
        assert.strictEqual(isPrivacySensitive('secrets.json'), true);
        assert.strictEqual(isPrivacySensitive('secret.toml'), true);
        assert.strictEqual(isPrivacySensitive('/config/secrets.json'), true);
      });

      it('blocks GCP service-account keys', () => {
        assert.strictEqual(isPrivacySensitive('service-account.json'), true);
        assert.strictEqual(isPrivacySensitive('service_account_key.json'), true);
        assert.strictEqual(isPrivacySensitive('/gcp/serviceaccount-prod.json'), true);
      });
    });
